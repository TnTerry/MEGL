...
# Directly load the vit model from a CLIP model
class MEGL_ViT(nn.Module):
    def __init__(self, explanation_type:str, clip_vision_transformer:CLIPVisionTransformer, num_classes:int, ) -> None:
        super(MEGL_ViT, self).__init__()
